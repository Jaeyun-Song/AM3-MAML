...
class LabelCUB(CombinationMetaDataset):
    """
    ...
    def __init__(self, root, num_classes_per_task=None, meta_train=False,
        ...
        super(LabelCUB, self).__init__(dataset, num_classes_per_task,
...
class CUBClassDataset(ClassDataset):
    ...
    def __getitem__(self, index):
        ...
        return CUBDataset(index % self.num_classes, data, label, transform=transform,
