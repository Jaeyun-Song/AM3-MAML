...
class LabelMiniImagenet(CombinationMetaDataset):
    """
    ...
    def __init__(self, root, num_classes_per_task=None, meta_train=False,
        ...
        dataset = MiniImagenetClassDataset(root, meta_train=meta_train,
            ...
            download=download)
        super(LabelMiniImagenet, self).__init__(dataset, num_classes_per_task,
...
class MiniImagenetClassDataset(ClassDataset):
    ...
    def __getitem__(self, index):
        ...
        return MiniImagenetDataset(index % self.num_classes, data, class_name,
...
if __name__ == '__main__':
    ...
    train_dataset = LabelMiniImagenet(root='../data',
